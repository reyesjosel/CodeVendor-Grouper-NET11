...
namespace CodeVendor.Controls
{
	...
	public class Grouper : System.Windows.Forms.UserControl
	{
        ...
        // Removing base.Size = new Size(368, 288) means DefaultSize now falls back to UserControl's
        // default of (150, 150). This is fine since your designer always sets explicit sizes, but
        // if you want to preserve the original intent cleanly:
        // This is optional — it only affects what size appears when
		// you first drag the control from the Toolbox onto a form.
        protected override Size DefaultSize => new Size(368, 288);
        ...
        // Visible is already the default for most properties — so it's harmless on primitive types
		// (bool, int, Color, float, string). But on Image it tells the designer to serialize the
		// image as inline code, which it cannot do — images must be stored in .resx resources.
		// If you ever assign a GroupImage at design time this will cause a designer error.
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] // ← not Visible
